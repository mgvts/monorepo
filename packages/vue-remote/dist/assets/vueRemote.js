...
const currentImports = {};
      ...
      let moduleMap = {
"./VueComponent":()=>{
      dynamicLoadingCss([], false, './VueComponent');
      return __federation_import('./__federation_expose_VueComponent-b32e1aa7.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
      const dynamicLoadingCss = (cssFilePaths, dontAppendStylesToHead, exposeItemName) => {
        ...
        const curUrl = metaUrl.substring(0, metaUrl.lastIndexOf('vueRemote.js'));
        const base = '/';
        'assets';
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__vueRemote__' + exposeItemName;
