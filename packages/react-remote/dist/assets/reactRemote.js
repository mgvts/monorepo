...
const currentImports = {};
      ...
      let moduleMap = {
"./mountReactComponent":()=>{
      dynamicLoadingCss([], false, './mountReactComponent');
      return __federation_import('./__federation_expose_MountReactComponent-be51e836.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
      const dynamicLoadingCss = (cssFilePaths, dontAppendStylesToHead, exposeItemName) => {
        ...
        const curUrl = metaUrl.substring(0, metaUrl.lastIndexOf('reactRemote.js'));
        const base = '/';
        'assets';
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__reactRemote__' + exposeItemName;
